...
5. Edit **hardhat.config.js** to add the A1 testnet and your funded test account. Refer to the [Milkomeda docs](http://localhost:3000/milkomeda-documentation/cardano/for-developers/obtaining-test-ada) for information on how to get testnet funds.
...
By clicking on the chain, we will now be able to choose Milkomeda A1 Testnet.
