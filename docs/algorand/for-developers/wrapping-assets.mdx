...
In order to **transfer assets from Algorand (mainchain) to the Milkomeda A1 Rollup**, you need to use dedicated Bridge DApp.
To wrap your assets onto the A1 Rollup go to the Milkomeda A1 bridge DApp at [https://algorand-bridge.milkomeda.com/](https://algorand-bridge.milkomeda.com/).
...
:::note
If you want to learn how to unwrap mALGOs, you can find out how to do that by visiting [Unwrapping Assets](https://dcspark.github.io/milkomeda-documentation/algorand/for-end-users/unwrapping-assets).
:::

:::note
Moreover, if you want to wrap/unwrap ASA, go to: [Algorand Standard Assets Support](https://dcspark.github.io/milkomeda-documentation/algorand/for-end-users/algorand-bridge-supported-asa).
:::