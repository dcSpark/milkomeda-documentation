...
<h4>Configuring Your MyAlgo Wallet</h4>


First, go to <a href="https://wallet.myalgo.com/new-account">https://wallet.myalgo.com/new-account</a>. After accepting the _Terms of Service_ click _Continue_ to start configuring your wallet. In the next step you will be asked to create a password. Then you should **create a new randomly generated account**.
...
To interact with the Bridge dApp you need to have the testnet ALGO token, ALGO.
