...
<h3>Unwrapping Algorand Standard Assets with the Milkomeda Bridge</h3>

Go to the Milkomeda A1 Bridge dApp at <a href="https://algorand-bridge-dev.milkomeda.com/">https://algorand-bridge-dev.milkomeda.com/</a>. To start unwrapping your assets, choose the **Milkomeda to Algorand** direction from the "Network Origin" dropdown menu. Then **select the appropriate token (EURe)** from the "Select Token" dropdown menu.
