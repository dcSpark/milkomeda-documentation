...
```
graph create milkomeda/subgraph_tutorial_c1 --node http://127.0.0.1:8020

graph deploy milkomeda/subgraph_tutorial_c1 --ipfs http://localhost:5001  --node http://localhost:8020 --output-dir artifacts/subgraph -l 0.1
...
We can now query our subgraph and it will have indexed the events from Milkomeda C1 Devnet.
