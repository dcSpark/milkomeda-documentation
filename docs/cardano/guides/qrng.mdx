...
If you're here solely for the purpose of generating QRNGs on Milkomeda C1 using API3, skip the introduction and head straight to the [Creating the Smart Contract](#smart-contract) section, that covers this topic.
...
## Creating the Smart Contract {#smart-contract}
