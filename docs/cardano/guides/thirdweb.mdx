...
This guide will show you how to deploy a simple smart contract to Milkomeda C1, an EVM-based sidechain connected to Cardano.
...
If that is not the case, please refer to the [doc on configuring Metamask](../for-developers/configuring-metamask-for-devs.mdx) and [obtaining test ADA](../for-developers/obtaining-test-ada.mdx).
