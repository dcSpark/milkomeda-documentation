...
To address this, **Wrapped Smart Contracts (WSC)** present an innovative concept, allowing users to interact with Dapps on L2 while retaining the security of their funds on the L1.
...
The [Developers](/cardano/wrapped-smart-contracts/for_developers) documentation and to [How to integrate](/cardano/wrapped-smart-contracts/how_to_integrate) page provides comprehensive guidance on implementing WSC within their projects.
