...
기본 URL이 코드에 포함된 경우 다음 엔드포인트 중 하나를 사용할 수 있습니다.
...
#### 이 기사와 Milkomeda의 협력에 대해 궁금한 점이 있으면 [https://www.milkomeda.com/support](https://www.milkomeda.com/support) 또는 < a href="https://discord.gg/4GSwPJpF">Discord 서버</a>에 문의하시기 바랍니다.
