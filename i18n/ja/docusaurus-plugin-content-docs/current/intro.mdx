...
**Milkomeda** は、非EVMブロックチェーンにEVM機能を提供する革新的なプロトコルです。 今後Milkomedaは、Cardano、Solana、Algorandなど主要なブロックチェーン向けにL2ソリューション（ロールアップ）の提供を拡大する予定です。 Currently we have an EVM-based sidechain connected to Cardano - <strong>Milkomeda C1</strong> and EVM-based Rollup connected to Algorand - <strong>Milkomeda A1</strong>.
