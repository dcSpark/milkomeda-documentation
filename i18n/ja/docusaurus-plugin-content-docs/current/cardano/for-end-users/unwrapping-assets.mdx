...
Remember to select the appropriate network in your wallet. <br /> Only connect with sites you trust. Make sure the website URL is as follows: `https://cardano-bridge.milkomeda.com`
...
<img className="img-full" src="/img/token-selection.png" />
...
<img className="img-full" src="/img/blockchain-confirmation.png" alt="Blockchain confirmation" />
...
<img className="img-full" src="/img/address-bar-link.png" alt="Address bar link" />
...
<img className="img-full" src="/img/search-box-blockscout.png" alt="Search box in Blockscout" />
