...
In order to **transfer assets from Algorand (mainchain) to the Milkomeda A1 Rollup**, you need to use our dedicated Bridge dApp. To wrap your assets onto the A1 Rollup go to the Milkomeda A1 bridge dApp at [https://algorand-bridge-dev.milkomeda.com/](https://algorand-bridge-dev.milkomeda.com/).
