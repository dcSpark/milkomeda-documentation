...
左側の「**Deploy and run transactions**（トランザクションのデプロイと実行）」アイコンをクリックして、以下のとおり「**Environment**（環境）」プルダウンから「**Injected Web3**」を選択します。 This will bring up the MetaMask screen where you will need to click "**Next**" and then "**Connect**" to connect your A1 wallet with Remix.
