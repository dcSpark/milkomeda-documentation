...
In order to interact with the **Milkomeda Algorand Rollup Bridge**, you need to configure a native Algorand wallet. We recommend using MyAlgo wallet to setup a testnet wallet compatible with the Milkomeda A1 Bridge. We recommend using MyAlgo wallet to setup a testnet wallet compatible with the Milkomeda A1 Bridge.

### Configuring Your MyAlgo Wallet

First, go to [https://wallet.myalgo.com/new-account](https://wallet.myalgo.com/new-account). After accepting the _Terms of Service_ click _Continue_ to start configuring your wallet. In the next step you will be asked to create a password. Then you should **create a new randomly generated account**. After accepting the _Terms of Service_ click _Continue_ to start configuring your wallet. In the next step you will be asked to create a password. Then you should **create a new randomly generated account**.
...
To interact with the Bridge dApp you need to have the testnet ALGO token, ALGO. 首先，我们建议从官方的测试网分配器 [https://testnet.algoexplorer.io/dispenser](https://testnet.algoexplorer.io/dispenser) 获得一些测试网ALGO。 首先，我们建议从官方的测试网分配器 [https://testnet.algoexplorer.io/dispenser](https://testnet.algoexplorer.io/dispenser) 获得一些测试网ALGO。
