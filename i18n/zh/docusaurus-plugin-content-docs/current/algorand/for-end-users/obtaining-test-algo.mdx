...
In order to interact with the **Milkomeda Algorand Rollup Bridge**, you need to configure a native Algorand wallet. We recommend using MyAlgo wallet to setup a testnet wallet compatible with the Milkomeda A1 Bridge. We recommend using MyAlgo wallet to setup a wallet compatible with the Milkomeda A1 Bridge DApp (used for moving assets between Mainchain and Rollup).
