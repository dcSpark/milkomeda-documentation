...
></p>
Click “**Save**”, and you will now see **Milkomeda Algorand** in the network dropdown list. Copy your Milkomeda Algorand wallet address from MetaMask to the clipboard by clicking on the account name, as shown. Copy your Milkomeda Algorand Mainnet wallet address from MetaMask to the clipboard by clicking on the account name, as shown.
